 ...
 * It will receive the JSON and instantiate the correct subclass according to the {@code type} key.
 */
public class ShapeAdapter implements JsonDeserializer<Shape> {

    // This method is from JsonDeserializer.
    ...
    public Shape deserialize(JsonElement e, Type shapeClass, JsonDeserializationContext context) throws JsonParseException {
        ...
        // But we can ask Gson to generate the origin directly from the JSON tree.
